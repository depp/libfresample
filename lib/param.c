...
static const struct lfr_quality LFR_QUALITY[MAX_QUALITY + 1] = {
    {  40, 65536*8/48, 1, 65536* 8/16 }, /* low */
    {  48, 65536*8/48, 1, 65536* 8/16 },
    {  56, 65536*8/48, 1, 65536* 8/16 },
    {  64, 65536*8/48, 1, 65536* 9/16 },
    {  72, 65536*8/48, 1, 65536*10/16 }, /* medium */
    {  78, 65536*7/48, 0, 65536*11/16 },
    {  84, 65536*6/48, 0, 65536*12/16 },
    {  90, 65536*5/48, 0, 65536*13/16 },
    {  96, 65536*4/48, 0, 65536*14/16 }, /* high */
    { 120, 65536*3/48, 0, 65536*15/16 },
    { 144, 65536*2/48, 0, 65536*15/16 }  /* ultra */
};
