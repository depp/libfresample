    ...
    const struct lfr_filter *filter)
{
    ...
    accumulate:
        ...
        case 1: case 5:
            acc1 = _mm_add_ps(
                _mm_unpacklo_ps(acc0, acc),
                _mm_unpackhi_ps(acc0, acc));
            break;
        ...
        case 3:
            acc0 = _mm_add_ps(
                ...
                _mm_unpackhi_ps(acc0, acc));
            acc2 = _mm_add_ps(
                _mm_movelh_ps(acc1, acc0),
                _mm_movehl_ps(acc0, acc1));
            break;
        ...
        case 7:
            ...
            _mm_storeu_si128((__m128i *) out + (i >> 3), accr);
            break;
        }
    ...
    *dither = ds;
    ...
    for (i = outlen; ; ++i) {
        ...
        case 7:
            ...
            memcpy((__m128i *) out + (i >> 3), &accr, (outlen & 7) * 2);
            return;
        }
    }
